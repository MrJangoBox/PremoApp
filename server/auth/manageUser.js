...
module.exports = function (server, db) {
    ...
    server.post('/api/v1/sauveApp/auth/register', function (req, res, next) {
        var user = req.params;
    ...
    server.post('/api/v1/sauveApp/auth/login', function (req, res, next) {
        var user = req.params;

        console.log("WAZZA", req.params.email)
